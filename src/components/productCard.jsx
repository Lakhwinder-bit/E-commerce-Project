...
export default function ProductCard({ item }) {
  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow relative hover:scale-102 transform duration-200 ease-in cursor-pointer">
      ...
      <div className="p-2">
        <div className="flex flex-row-reverse justify-between">
          ...
          <div className="mt-2">
            ...
            <p className="text-sm text-gray-500 mt-3">{productName}</p>
            ...
            <div className="flex gap-2 mt-3 ">
              {variants.map((variant) => (
                <button
                  ...
                  className="w-4 h-4 rounded-full border-0 ring-1 cursor-pointer  hover:scale-120 transform duration-200 ease-in-out"
